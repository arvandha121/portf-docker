...
@section('content')
    <div class="container mx-auto px-2 py-4">
        <h1 class="text-2xl font-bold mb-6 text-gray-800">Edit Profil Pengguna</h1>
        ...
        <form action="{{ route('homes.update', $home->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <input type="text" name="nama" id="nama" value="{{ $home->nama }}" required
            ...
            <div>
                ...
                <textarea name="teks" id="teks" rows="2" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none">{{ $home->teks }}</textarea>
            </div>
            ...
            <div class="col-span-1 md:col-span-2 flex justify-between items-center pt-4">
                ...
                <a href="{{ route('homes.index') }}" class="text-gray-600 hover:underline">Batal</a>
            </div>
        </form>
    </div>
@endsection
